...
```javascript
const b = "GITHUB_TOKEN_EXAMPLE_DO_NOT_USE"
...
const octokit = new Octokit({
  auth: "GITHUB_TOKEN_EXAMPLE_DO_NOT_USE",
});
...
```javascript
const b = "GITHUB_TOKEN_EXAMPLE_DO_NOT_USE // risky token"
...
const octokit = new Octokit({
  auth: "GITHUB_TOKEN_EXAMPLE_DO_NOT_USE // risky token",
});
